...
//             filtered = filtered.filter((course) => course.course_name.toLowerCase().trim().includes(searchTerm.toLowerCase().trim()));
//         }
...
//                     <div>
//                         <span className="text-gray-700">Total Courses: {totalCourses}</span>
//                         <span className="ml-4 text-gray-700">Active Courses: {activeCourses}</span>
//                     </div>
//                 </div>
//             </div>
...
//                         <input type="text" value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} placeholder="Search courses here" className=" rounded p-2 grow" />


//                         <div className="flex space-x-4">
//                             <select
//                                 className="form-select rounded shadow-sm p-2 focus:border-none"
//                                 value={statusFilter}
...
//                             </select>
//                             <select
//                                 className="form-select rounded border-none shadow-sm p-2 focus:border-none"
//                                 value={typeFilter}
