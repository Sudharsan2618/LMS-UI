...
// const CourseCard = ({ course, rate = true }) => {
...
const CourseCard = ({ course, rate = true }) => {
    ...
    return (
        <div
            onClick={() => handleCourseRedirect(course.course_id)}
            className="bg-white rounded-lg shadow-md overflow-hidden transition-transform transform hover:scale-105 hover:shadow-xl cursor-pointer"
        >
            {/* Course Profile Image */}
            <img
                src={course.course_profile_image}
