        ...
        <div className="container mx-auto px-6 md:px-12 flex flex-col-reverse md:flex-row items-center gap-12">
          <div className="text-center md:text-left space-y-6">
            ...
            <p className="text-lg text-gray-700 max-w-xl mx-auto md:mx-0">
              We are redefining the way people learn and grow in their careers with innovation, technology, and education.
            </p>
            <Link href="/dashboard/courses">
            ...
            <div className="md:w-1/2 text-left space-y-6">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <p className="text-lg text-gray-700"><strong>Empowering Connections:</strong> Connecting learners with their ideal institutions seamlessly.</p>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-2xl">🚀</span>
                  <p className="text-lg text-gray-700"><strong>Innovation at Its Core:</strong> Redefining education with cutting-edge technology.</p>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-2xl">🌍</span>
                  <p className="text-lg text-gray-700"><strong>Community Development:</strong> Fostering a thriving educational ecosystem.</p>
                </li>
              </ul>
        ...
        <div className="container mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="#" className="text-gray-400 hover:text-white text-sm">Courses</Link></li>
              <li><Link href="#" className="text-gray-400 hover:text-white text-sm">Certifications</Link></li>
              <li><Link href="#" className="text-gray-400 hover:text-white text-sm">Virtual Internships</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col space-y-2">
              <Link href="https://x.com/TattiSkills" className="text-gray-400 hover:text-white text-sm">Twitter</Link>
              <Link href="https://www.linkedin.com/company/tamilnadu-advanced-technical-training-institute/" className="text-gray-400 hover:text-white text-sm">LinkedIn</Link>
              <Link href="https://www.facebook.com/TattiChennai" className="text-gray-400 hover:text-white text-sm">Facebook</Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-gray-400"><strong>Address:</strong> 42/25, Gee Gee Complex, Anna Salai, Mount Road, Triplicane, Chennai, Tamil Nadu 600002</p>
            </div>
          </div>
